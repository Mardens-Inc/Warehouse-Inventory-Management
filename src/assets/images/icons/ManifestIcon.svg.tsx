interface ManifestIconIconProperties
{
    width?: number | string;
...
export default function ManifestIcon(props: ManifestIconIconProperties)
{
    return (
        <svg width={props.size || props.width || "18"} height={props.size || props.height || "20"} viewBox="0 0 18 20" fill={"none"} xmlns="http://www.w3.org/2000/svg" style={{minWidth: props.size || props.width || "10px", maxWidth: props.size || props.width || "100px", minHeight: props.size || props.height, maxHeight: props.size || props.height}}>
            <path
